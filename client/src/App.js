...
const App = () => {
  ...
  let whiteistedaddress = [
    'wallet addresses come here',
    'wallet addresses come here',
  ];

  // Address you want to find merkle HexProofm is the wallet address of the account connect to this page  .......
  ...
  const mint = () => {
    console.log(COUNT);
    // THIS IS WHERE I SWITCH TO MANUALLY
    contract.methods
      .publicSaleMint(COUNT, proof)
        ...
        <div className="row">
          <div className="col d-flex flex-column align-items-center">
            <h1 className="display-6 fw-bold">
              {' '}
              Welcome to Randoms NFT Minting Page{' '}
            </h1>
            {/* <img className="mb-4"src='C:\Users\Daniel Awodeji\Desktop\CreativeJuices\client\public\Untitled.png' width="200"/> */}
            <div className="col-5 text-center">
              <p className="lead text-center">
                More than just a picture, our genesis collection of 444 Random
                OGs welcomes you to the world of Web3. We are commited to
                building the future of web3 where everyone across the globe
                shares the feeling of brotherhood. This genesis collection
                unlocks a pass to future NFT drops and alpha communities across
                the web3 community. RANDS go brrrrrrrr!!!
              </p>
              <div>
                <input
                  type="number"
